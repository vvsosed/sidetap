...
class Router:
    ...
    def poll_once(self) -> int:
        ...
        straight to the speakers by WirePlumber: undecked, unjournalled, and
        ...
        for stream in snapshot.by_class(PLAYBACK_STREAM):
            if not stream.matches(self._app_pattern):
                continue
        ...
        # Append to the journal BEFORE touching the graph, same as engage().
